...
@WebServlet(description = "\u5f02\u6b65\u52a0\u8f7d\u671f\u520a\u7b49\u7ea7", urlPatterns = { "/PubPart" })
public class PubPart extends HttpServlet
{
    ...
    private void FindValue(final HttpServletRequest request, final HttpServletResponse response) throws IOException {
        ...
        final String sql = "select * from pubpart where pubpartname = ?";
