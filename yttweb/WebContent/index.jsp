...
<html>
	...
	<body>
		<!-- 你的HTML代码 -->
		<div style="display:none" class="qiqiu1 qiqiu">
			<img src="images/login/q2.png" />
			<div class="text">love</div>
		</div>
		<div style="display:none" class="qiqiu2 qiqiu">
			<img src="images/login/q3.png" />
			<div class="text">love</div>
		</div>
		<div style="display:none" class="qiqiu3 qiqiu">
			<img src="images/login/q4.png" />
			<div class="text">love</div>
		</div>
		<div style="display:none" class="qiqiu4 qiqiu">
			<img src="images/login/q5.png" />
			<div class="text">love</div>
		</div>
		<div style="display:none" class="qiqiu5 qiqiu">
